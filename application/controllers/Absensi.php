    ...
    public function index()
{
    ...
    // var_dump($today);die; 
    $show_view = false; // Default-nya false
    $label_check = '';

    // Mengambil semua data absensi untuk hari ini (beberapa row)
    $attendances = $this->absensi_model->getAttendanceByDate($id_user, $today);

    // Variabel untuk mendeteksi status check_in dan check_out
    $has_check_in = false;
    $has_check_out = false;
    ...
    if ($attendances) {
        ...
        // Logika untuk mengatur $show_view dan $label_check berdasarkan hasil deteksi
        ...
        // Untuk memastikan apakah nilai show_view dan label_check sudah benar
        // var_dump($show_view); 
        // var_dump($label_check);
        // die;

        // Ambil data dari row terakhir (karena query-nya limit 2)
