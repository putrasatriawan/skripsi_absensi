...
class Login extends CI_Controller
{
	...
	public function forgot_password()
	{
		...
		$this->data['title'] = 'ZoneWafe | Lupa Password';
	...
	public function reset_password($code = NULL)
	{
		...
		$this->data['title'] = 'ZoneWafe | Reset Password';
	...
	public function create_password($code = NULL)
	{
		...
		$this->data['title'] = 'ZoneWafe | Buat Password';
	...
	private function send_mail($email, $name, $link, $code)
	{
		...
		$mail->Subject = 'Reset password akun ZoneWafe';
		$this->data['nama'] = $name;
