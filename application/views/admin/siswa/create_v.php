        ...
        <!-- <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>Tambah Ruang </div>
                </div>
            </div>
        </div> -->
        <div class="row">
            <div class="col-sm-8 offset-md-2">
                <form method="POST" id="form-ruang" enctype="multipart/form-data">
                    <div class="main-card mb-3 card">
                        <div class="card-body"> <?php
                                                if (!empty($this->session->flashdata('message_error'))) { ?> <div
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 form-label">Nama Siswa/Siswi</label>
                                <div class="col-sm-9">
                        ...
                        <div class="card-footer bg-light align-items-center justify-content-end">
                            <a href="<?php echo base_url(); ?>ruang" class="btn btn-outline-secondary mr-2">
