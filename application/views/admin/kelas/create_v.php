                ...
                <form method="POST" id="form-kelas" enctype="multipart/form-data">
                    <div class="main-card mb-3 card">
                        ...
                        <div class="alert alert-danger"> 
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 form-label">Nama Kelas</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="th_ajaran" class="form-control" placeholder="Masukkan Tahun Ajaran">
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-light align-items-center justify-content-end">
                            <a href="<?php echo base_url(); ?>kelas" class="btn btn-outline-secondary mr-2"><span class="btn-icon-wrapper pr-2 opacity-7"><i class="fa fa-times fa-w-20"></i> </span>Batal </a>
                            <button type="submit" id="save-btn" class="btn btn-primary"><span class="btn-icon-wrapper pr-2 opacity-7"><i class="fa fa-save fa-w-20"></i> </span>Simpan </button>
                        </div>
                    </div>
                </form>
            </div>
