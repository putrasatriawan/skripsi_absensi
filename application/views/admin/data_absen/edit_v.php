                            ...
                            <div class="col-sm-9">
                                <select name="kelas_id" class="form-control">
                                    ...
                                    <option value="<?php echo $row->id; ?>" 
                                        <?php echo ($row->id == $kelas_id) ? 'selected' : ''; ?>>
                                        <?php echo $row->name; ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <select name="nomor_kelas" class="form-control">
                                    ...
                                    <option value="<?php echo $letter; ?>" 
                                        <?php echo ($letter == $nomor_kelas) ? 'selected' : ''; ?>>
                                        <?php echo $letter; ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="jurusan_id" class="form-control">
                                    ...
                                    <option value="<?php echo $row->id; ?>" 
                                        <?php echo ($row->id == $jurusan_id) ? 'selected' : ''; ?>>
                                        <?php echo $row->name; ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                                ...
                                <select name="tahun_angkatan" class="form-control">
                                    ...
                                    for ($i = $currentYear - 10; $i <= $currentYear + 1; $i++): ?>
                                        <option value="<?php echo $i; ?>" 
                                            <?php echo ($i == $tahun_angkatan) ? 'selected' : ''; ?>>
                                            <?php echo $i; ?>
                                        </option>
                                    <?php endfor; ?>
                                </select>
